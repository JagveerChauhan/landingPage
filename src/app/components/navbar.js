...
export default function Navbar()
{
    return(
        ...
        <span className="py-6">
          <Link onClick={()=>"gtag_report_conversion('tel:9650076857')"} className="py-1 md:py-3 px-2 md:px-6 bg-dark-blue text-white rounded-2xl font-semibold font-DM Sans" href="tel:+919650076857">Call Now</Link>
        </span>
      </nav></>
    )
}