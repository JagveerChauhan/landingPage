    ...
    <>
      ...
      <div className="px-2 py-10 md:px-10 lg:px-20 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-6 bg-dark-blue text-white font-DM Sans">
        <div className="flex flex-col justify-center gap-8 md:gap-10 px-6 sm:px-10 md:px-0 py-6">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold md:max-w-md">We’re here to Increase your Productivity</h1>
          <p className="text-sm font-medium md:max-w-md">Let&apos;s make your work more organize and easily using the Taskio Dashboard with many of the latest featuresin managing work every day.</p>
      ...
      <div className="pt-10 pb-8 md:pt-20 md:pb-14 px-4 sm:px-10 md:px-20 flex flex-col gap-6 text-center max-w-screen-lg mx-auto font-DM Sans">
        <p className="text-4xl md:text-5xl font-bold leading-snug md:leading-[1.4]">We Offer a Wide Range Of Services Designed to Optimize Your Business and Achieve Your <span className="text-blue">Goals</span></p>
        <p className="text-sm text-neutral-800 leading-loose">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium totam rem aperiam eaque quae abillo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabos</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-10 gap-y-6 px-10 pt-4 pb-20 font-DM Sans">
        <div className="group flex flex-col gap-4 px-4 py-6 border-2 border-transparent rounded-3xl hover:border-blue transition-all duration-700 shadow-[0px_10px_60px_rgba(155,_155,_155,_0.1)]">
          ...
          <p className="text-base text-center font-medium text-neutral-500 leading-relaxed">Website Design, Corporate Identity Design, Banner & Print Designs.</p>
        </div>
        <div className="group flex flex-col gap-4 px-4 py-6 border-2 border-transparent rounded-3xl hover:border-blue transition-all duration-700 shadow-[0px_10px_60px_rgba(155,_155,_155,_0.1)]">
          <span className="flex justify-start p-5 w-fit bg-sky-100 rounded-full mx-auto group-hover:bg-blue transition-all duration-700">
          ...
          <p className="text-base text-center font-medium text-neutral-500 leading-relaxed">IOS and Android Mobile App Solutions.</p>
        </div>
        <div className="group flex flex-col gap-4 px-4 py-6 border-2 border-transparent rounded-3xl hover:border-blue transition-all duration-700 shadow-[0px_10px_60px_rgba(155,_155,_155,_0.1)]">
          <span className="flex justify-start p-5 w-fit bg-sky-100 rounded-full mx-auto group-hover:bg-blue transition-all duration-700">
          <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" fill="currentColor" className="bi bi-laptop fill-blue group-hover:fill-white transition-all duration-700" viewBox="0 0 16 16">
          ...
          <p className="text-base text-center font-medium text-neutral-500 leading-relaxed">Custom Coding and CMS Integration.</p>
        </div>
        <div className="group flex flex-col gap-4 px-4 py-6 border-2 border-transparent rounded-3xl hover:border-blue transition-all duration-700 shadow-[0px_10px_60px_rgba(155,_155,_155,_0.1)]">
          <span className="flex justify-start p-5 w-fit bg-sky-100 rounded-full mx-auto group-hover:bg-blue transition-all duration-700">
      ...
      <div className="p-10 bg-dark-blue text-white grid grid-cols-2 md:grid-cols-4 font-DM Sans">
        <div className="flex flex-col justify-center p-4 text-center"> 
          <span className="text-4xl font-bold">1253+</span>
      ...
      <div className="p-12 font-DM Sans">
        ...
        <p className="text-base py-4 text-center">Boost Your Organic Search Presence, Get More Customers, Expand into New Markets, and Generate More Revenue with a Mobile-Friendly Website Design.</p>
        <div className="grid grid-col-1 md:grid-col-2 lg:grid-cols-4">
          <div className="flex flex-col gap-1 text-center px-4 py-2">
            ...
            <p className="text-base">By keeping an eye on all the important metrics, our design & development team creates a user journey.</p>
          </div>
          <div className="flex flex-col gap-1 text-center px-4 py-2">
            ...
            <p className="text-base">Our team has expertise in HTML, CSS, and JavaScript and creates websites that perform.</p>
          </div>
          <div className="flex flex-col gap-1 text-center px-4 py-2">
          ...
          <div className="flex flex-col gap-1 text-center px-4 py-2">
            ...
            <p className="text-base">We create websites that look and perform well on all devices. A mobile-friendly website helps you get more customers.</p>
          </div>
        </div>
      </div>
      <div className="grid justify-center  bg-dark-blue">
        <div className="flex flex-col md:flex-row gap-16 md:gap-6 p-2 sm:p-10 md:p-20 text-white">
          <div className="flex flex-col gap-4 md:max-w-screen-md">
            ...
            <p className="text-base font-medium text-neutral-300">Fluxi is the #1 marketing strategy platform showing you the exact content to create to increase first page rankings and drive outcomes.</p>
          </div> 
        ...
        <div className="p-2 z-10 grid grid-cols-1 md:grid-cols-2 font-DM Sans bg-white rounded-lg md:max-w-screen-md m-auto">
          <div className=" z-10 px-6 sm:px-10 md:px-0 bg-dark-blue rounded-lg py-10 bg-[url('/images/circle.png')] overflow-hidden bg-[length:200px_200px] bg-right-bottom bg-no-repeat">
            <div className="flex flex-col gap-8 md:gap-10">
              <h1 className="text-2xl px-4 sm:text-3xl md:text-4xl font-bold md:max-w-md text-white mx-auto">We’re here to Increase your Productivity</h1>
              <p className="text-sm px-4 font-medium md:max-w-md text-white mx-auto">Let&apos;s make your work more organize and easily using the Taskio Dashboard with many of the latest featuresin managing work every day.</p>
            </div>
      ...
      {/* Floating Buttons */}
      <Link href={'https://api.whatsapp.com/send?phone=+91&text=Hi'} className="fixed left-4 bottom-4">
      ...
      <Link href={'tel:'} className="fixed right-4 bottom-4">
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="60" height="60" viewBox="0 0 48 48">
