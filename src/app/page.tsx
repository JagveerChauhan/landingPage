...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Floating Buttons */}
      <Link onClick={()=>"gtag_report_conversion('tel:9650076857')"} href={'https://api.whatsapp.com/send?phone=+919650076857&text=Hi'} className="fixed left-4 bottom-4">
      ...
      <Link onClick={()=>"gtag_report_conversion('tel:9650076857')"} href={'tel:+919650076857'} className="fixed right-4 bottom-4">
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="60" height="60" viewBox="0 0 48 48">
